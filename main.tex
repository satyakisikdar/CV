...
\begin{document}
\makeheading{{\huge  Satyaki Sikdar} \hfill \scriptsize{\textmd{Generated: \today}}}
...
\section{Projects}
\textbf{Modeling graphs with Vertex Replacement Grammars} \hfill $2018$ -- 
\begin{loneinnerlist}
    \item[] Created a graph framework and related algorithms that can extract structural features from a given graph and use that to generate a family of topologically similar graphs. Tools used: Python with the NetworkX library.
\end{loneinnerlist}
...
\begin{innerlist}
    \item[] \href{https://goo.gl/pDRGwY}{\textit{Synchronous Hyperedge Replacement Graph Grammars}}, International \\  Conference on Graph Transformations, $2018$, Toulouse, France \hfill June $2018$
