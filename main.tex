...
\begin{loneinnerlist}
    \item[] Created a graph framework and related algorithms that extracts structural features from a given graph and uses that to generate a family of topologically similar graphs. Tools used: Python with the NetworkX library.
\end{loneinnerlist}
