...
\begin{document}
\makeheading{{\huge  Satyaki Sikdar} \hfill \scriptsize{\textmd{Generated: Aug 27, 2018}}}
...
\item[] Ph.D., 
        \href{http://cse.nd.edu}
             {Computer Science \& Engineering}, GPA: $3.93$
             \hfill $2017$ -- 
        \begin{innerlist}
        \item[] Adviser:
...
\section{Projects}
\textbf{Synchronous Hyperedge Replacement Graph Grammars} \hfill $2017$ -- 
\begin{loneinnerlist}
